...
const modalidades = {
    ordinaria: {
        ...
        info: `<div class="info-collapsible">
            ...
            <div class="info-content" id="infoContent" style="display: none;">
                <ol>
                    ...
                    <li>+ Seguro (0.5% del FOB)</li>
                    <li><strong>= Valor CIF USD</strong></li>
                    ...
                    <li>Arancel + IVA = <strong>Total Impuestos</strong></li>
    ...
    franquicia: {
        ...
        info: `<strong>📋 ¿Cuándo se aplica?</strong> Viajeros internacionales. Exento de arancel e IVA. Cupo libre: USD 200.`,
    ...
    'temporal-corto': {
        ...
        info: `<strong>📋 ¿Cuándo se usa?</strong> Para ferias, exposiciones, eventos. Los tributos se suspenden y se paga una póliza del 1.5%.`,
        ...
        calcular: (v) => {
            ...
            return [
                ...
                { label: 'Base Arancelaria COP', valor: formatCOP(r.baseArancelariaCOP) },
                { label: `Arancel (${r.arancelPorcentaje}%) — SUSPENDIDO`, valor: formatCOP(r.tributosSuspendidos), clase: 'suspendido' },
